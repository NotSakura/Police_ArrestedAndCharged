...
#The Access token: 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
...
toronto_arrested_clean <-
  ...
  select(arrest_year, category, subtype, arrest_count)
...
```{r}
#| echo: false
#| label: tb3-grouped by category
#| tb2-cap: Total arrested in by type of charge Toronto from 2014, 2022
## Now add the years for a cleaner data
...
#head(data_year)
data_cat |> kable(format = "pipe", padding = 2, col.names = c("Category", "Arrest Count"))
